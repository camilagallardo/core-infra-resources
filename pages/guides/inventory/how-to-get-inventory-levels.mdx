---
title: How to get inventory levels for a product
description: Guide on how to use our API to get inventory levels for a product
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/UFFhorrushU?si=gX2ObrEK84Buh3eW" title="Inventory Service: PromoStandards Education Series" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
<hr></hr>
...
### HTTP VERB: `GET`
### URL: https://api.psrestful.com/v1.0.0/suppliers/{SUPPLIER_CODE}/inventory/{PRODUCT_ID}/
