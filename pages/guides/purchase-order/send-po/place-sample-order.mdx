---
title: How to place a Purchase Order for a sample order
description: Guide on how to use our API to place a Purchase Order for sample order(PromoStandards)
